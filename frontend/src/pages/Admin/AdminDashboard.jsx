...
const AdminDashboard = () => {
  ...
  const totalRaised = patients.reduce((sum, p) => sum + p.amountRaised, 0);
  const totalNeeded = patients.reduce((sum, p) => sum + p.amountNeeded, 0);
                ...
                {patients.map((patient) => (
                  <tr key={patient.id} className="border-b border-neutral-light hover:bg-neutral-light transition-colors">
                    ...
                    <td className="px-6 py-4 hidden lg:table-cell text-dark font-body">
                      {formatCurrency(patient.amountRaised)}
                    </td>
                    <td className="px-6 py-4 hidden lg:table-cell text-dark font-body">
                      {formatCurrency(patient.amountNeeded)}
                    </td>
                    <td className="px-6 py-4">
